...
Object.defineProperty(exports, "typesSpec", {
  enumerable: true,
  get: function () {
...
function getChainTypes(specName, chainName) {
  return _objectSpread(_objectSpread({}, _spec.default[specName] || {}), _chain.default[chainName] || {});
}