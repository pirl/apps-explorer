...
declare function AddressRow({ buttons, children, className, defaultName, isContract, isDisabled, isInline, isValid: propsIsValid, overlay, value, withTags }: Props): React.ReactElement<Props> | null;
